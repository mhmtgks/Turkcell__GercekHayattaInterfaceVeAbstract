...
class TWFSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class TWFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TWFDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new TWFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TWFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TWFDateTimeConverter dateTimeConverter = new TWFStandardDateTimeConverter();

    public TWFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TWFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TWFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TWFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TWFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TWFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
