...
public class TWFKPSPublicSoap
{
    ...
    public TWFKPSPublicSoap(){}

    public TWFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TWFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TWFExtendedSoapSerializationEnvelope envelope= new TWFExtendedSoapSerializationEnvelope(TWFExtendedSoapSerializationEnvelope.VER11);
